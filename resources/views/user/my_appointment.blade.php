...
<body>
    ...
    <div align="center" style="padding:70px;">
        <table>
            ...
            <tr align="center">
                <td style="padding:10px; font-size:10px">{{$appoints->doctor}}</td>
                <td style="padding:10px; font-size:10px">{{$appoints->date}}</td>
                <td style="padding:10px; font-size:10px">{{$appoints->message}}</td>
                <td style="padding:10px; font-size:10px">{{$appoints->status}}</td>

                <td><a class="btn btn-danger" onclick="return confirm('are you sure to delete this')"
                        href="{{url('cancel_appoint',$appoints->id)}}">Cencle</a></td>
            </tr>
            @endforeach
        </table>
